...
import { usePaytonicTransactionsList } from '@/services/wallet'
import { BankTransactionType } from '@/types/bank'
import { useState } from 'react'

const PaytonicTransactionsPage = () => {
  const { data: BankTransactionData, isLoading: loadingBankTransactions } =
    usePaytonicTransactionsList()
      ...
      >
        <div className="card !tw-rounded-se-none !tw-rounded-ss-none card-flush">
          ...
          <div className="card-body table-responsive pt-0">
            <table className="tw-w-full table align-middle table-row-dashed fs-6 gy-5">
              <thead>
              ...
              <tbody className="tw-w-full fw-semibold text-gray-600">
                {TransactionList && TransactionList.length > 0 ? (
                  ...
                  <div className="tw-w-full tw-text-center tw-py-10 tw-px-auto">
                    No data available
                  </div>
                )}
              </tbody>
...
export default PaytonicTransactionsPage
