...
import { useGetAirtimeList } from '@/services/bills'
...
const BankTransactionsPage = () => {
  const {
    ...
    isLoading: loadingAirtimeTransactions,
  } = useGetAirtimeList()
  console.log(AirtimeTransactionData?.data.data)

  const TransactionList = AirtimeTransactionData?.data.data
