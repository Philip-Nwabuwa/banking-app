...
import { SettlementsData, AccountData } from '@/types/statements'
          ...
          <div className="card-body tw-flex tw-gap-2 tw-items-center">
            ...
            <div className="tw-text-xl tw-font-bold">
              {AccountData.length > 0 ? (
                <p className="tw-mb-0">
                  Tranfer funds to any of the accounts below to fund your
                  account.
                </p>
              ) : (
                <p className="tw-mb-0">
                  Click the button bello to create a deposit account.
                </p>
              )}
            </div>
          </div>
